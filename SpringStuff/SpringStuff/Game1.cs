...
public class Game1 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        s1 = new Spring(new Vector2(50, 50), new Vector2(50, 100), 200.0f, 200.0f, 1, 50, 0.0f);
        allSpring[0] = s1;
        s2 = new Spring(new Vector2(200, 100), new Vector2(100, 200), 100.0f, 100.0f, 1, 25, 0.0f);
        allSpring[1] = s2;
        s3 = new Spring(new Vector2(400, 150), new Vector2(50, 100), 50.0f, 50.0f, 1, 100, 0.0f);
        allSpring[2] = s3;
        base.Initialize();
    }
